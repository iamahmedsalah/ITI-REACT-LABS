  ...
  return (
    <aside className="fixed left-0 top-0 h-full flex flex-col p-6 z-40 bg-background w-64 border-r border-white/5 shadow-2xl shadow-surface-container-lowest/50">
      <div className="mb-12 px-2">
        ...
        <div className="h-10 w-10 rounded-xl bg-linear-to-br from-primary to-on-primary-container flex flex-row items-center justify-center mb-4 shadow-lg shadow-primary/20">
          <HugeiconsIcon icon={UserFullViewIcon} className='w-7 h-7' />
            ...
            <p className="font-headline uppercase h-10 text-sm text-slate-500">{displayName}</p>
        </div>
      ...
      <button
        ...
        className="mt-auto flex items-center justify-center cursor-pointer gap-2 w-full py-3 rounded-xl bg-linear-to-br from-primary to-on-primary-container text-on-primary font-headline font-bold text-xs uppercase tracking-wider scale-95 active:scale-90 transition-all shadow-lg shadow-primary/10"
      >
