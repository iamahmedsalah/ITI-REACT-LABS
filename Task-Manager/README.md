...
Design & icons
- Uses simple, dark, card-based UI. For README icons we use emoji to keep the file lightweight.
- If you prefer SVG icons in the README, add them to `src/assets/screenshots/` and reference them above.

Contributing
- Improve components, add tests, or wire real data. Open a PR and describe your change.
